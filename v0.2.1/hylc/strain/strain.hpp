...
Vec6 ek(const Vec18 &xlocal, const Mat2x2 &invDm, const Real &A, const Real &l0,
        ...
        const Vec2 &t2);
Vec6 eklinear(const Vec18 &xlocal, const Mat2x2 &invDm, const Real &A,
...
ek_valdrv(const Vec18 &xlocal, const Mat2x2 &invDm, const Real &A,
          const Real &l0, const Real &l1, const Real &l2, const Vec2 &t0,
          const Vec2 &t1, const Vec2 &t2);
std::tuple<std::vector<Mat18x18>, Mat6x18, Vec6>
eklinear_valdrv(const Vec18 &xlocal, const Mat2x2 &invDm, const Real &A,
                const Real &l0, const Real &l1, const Real &l2, const Vec2 &t0,
                const Vec2 &t1, const Vec2 &t2);
} // namespace mathematica
} // namespace hylc
